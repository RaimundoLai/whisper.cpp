...
public:
    ...
    bool load_model(const std::string & model_path, bool use_gpu = true, bool debug = false);
...
private:
    ...
    bool load_tensor_data(const std::string & path, struct gguf_context * ctx, bool use_gpu, bool debug);
